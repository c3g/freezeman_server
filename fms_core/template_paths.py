...
SAMPLE_EXTRACTION_TEMPLATE = static("submission_templates/Extraction_v0.9.xlsx")
SAMPLE_SUBMISSION_TEMPLATE = static("submission_templates/Sample_submission_v0.12.xlsx")
