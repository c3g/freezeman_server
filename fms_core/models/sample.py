...
class Sample(models.Model):
    ...
    BIOSPECIMEN_TYPE_RTS = "RESPIRATORY SECRETION"
    ...
    BIOSPECIMEN_TYPE_CHOICES = (
        *BIOSPECIMEN_TYPE_NA_CHOICES,
        ...
        (BIOSPECIMEN_TYPE_RTS, BIOSPECIMEN_TYPE_RTS),
    ...
    TISSUE_SOURCE_RTS = "Respiratory secretion"
    ...
    TISSUE_SOURCE_CHOICES = (
        ...
        (TISSUE_SOURCE_RTS, TISSUE_SOURCE_RTS),
    ...
    BIOSPECIMEN_TYPE_TO_TISSUE_SOURCE = {
        ...
        BIOSPECIMEN_TYPE_RTS: TISSUE_SOURCE_RTS,
